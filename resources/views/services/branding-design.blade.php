...
@section('content')
    ...
    <section id="digitel-hero-sec"class="service-brandimg-hero" >
        <div class="row">
                    ...
                    <form action="{{route('website.form')}}" method="post" id="website-form">
                        ...
                        <div class="row">
                            <div class="col-md-8 form-text-filed">
                                ...
                                <input type="text" name="website_name" id="form_name" class="footer-form-field" placeholder="Enter your website" required>
...
<div id="player-overlay">
  <video   id="backgroundd-video" autoplay muted >
    <source src="{{asset('public/assets/img/service-branding.m4v')}}" type="video/mp4"/>
  </video>    
</div>


    <div class="mobile-servie-sec branding-bgs">
        <h2>We make the best websites for your brand at the most affordable price</h2>
        <form>

            <div class="row">
                <div class="col-md-8 form-text-filed">
                    <input type="text" name="name" id="form_name" class="footer-form-field" placeholder="Enter your website">
                </div>
                <div class="col-md-4">
                    <button type="submit" class="about-fa-btn before-btn header-btn site-button site-angle"> Send Me a Quote  &nbsp; <i class="fas fa-angle-up"></i> </button>
                </div>
        ...
        <img src="{{ asset('public/assets/img/imgpsh_fullsiz-removebg-previews.png')}}" alt="background" class="img-fluid" width="100%">
    </div>
    ...
    <section id="digitel-second-sec" class="branding-ser">
        <div class="row">
            <div class="col-xl-7">
                <h2>We make the best websites for Your brand at the most affordable price</h2>
            ...
            <div class="col-xl-5">
                <img src="{{ asset('public/assets/img/img-brandinghhh.png')}}" alt="img" class="img-fluid" >
            </div>
        </div>
    </section>
    ...
    <section id="digitel-scop">
        ...
        <div class="mobile-show-scope">
            ...
            <img src="{{ asset('public/assets/img/022.svg')}}"  class="img-fluid" alt="scop"><br>
            <img src="{{ asset('public/assets/img/033.svg')}}"  class="img-fluid" alt="scop"><br>
            <img src="{{ asset('public/assets/img/044.svg')}}"  class="img-fluid" alt="scop"><br>
            <img src="{{ asset('public/assets/img/055.svg')}}"  class="img-fluid" alt="scop">
        </div>
    </section>
