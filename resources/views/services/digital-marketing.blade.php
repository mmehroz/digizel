        ...
        <div class="row">
            <div class="col-xl-6 hero-left-sec ">
                ...
                <div class="hero-sec-btn digitel-sec-btn">
                    ...
                    <a href="tel:(866) 313-1877" class=" header-btn site-button site-angle"><p>Schedule a Call &nbsp; <img
                                src="{{asset('public/assets/img/imgpshblue.png')}}" alt="icon">
                        </p></a>
                </div>
...
<div id="player-overlay">
  <video   id="backgroundd-video" autoplay muted >
    <source src="{{asset('public/assets/img/service-marketing.m4v')}}" type="video/mp4"/>
  </video>    
</div>
    ...
    <section id="digitel-scop">
        <img src="{{asset('public/assets/img/Capturefffsdf.png')}}" class="desktop-show-scope  img-fluid" alt="scop">
        ...
        <div class="best-services-bg">
            ...
            <div class="row">
                <div class="col-xl-6 service-column">
                    ...
                    <p>Our designers, typesetters, programmers, and marketing specialists are always there to help you
                        implement any project.</p>
