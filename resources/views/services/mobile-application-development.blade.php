...
@section('content')
    ...
    <section id="digitel-hero-sec" class="service-mobile">
        <div class="row">
            <div class="col-xl-6 hero-left-sec ">
                ...
                <div class="hero-sec-btn digitel-sec-btn">
                    <a href="pricing.html" class="header-btn hero-pkg-btn site-button site-angle" > <p>View Packages  &nbsp; <img src="{{asset('public/assets/img/imgpshblue.png')}}" alt="icon">
                        </p></a>
                    <a href="tel:(866) 313-1877" class=" header-btn site-button site-angle"> <p>Schedule a Call  &nbsp; <img src="{{asset('public/assets/img/imgpshblue.png')}}" alt="icon">
                        </p></a>
                </div>
...
<div id="player-overlay">
  <video   id="backgroundd-video" autoplay muted >
    <source src="{{asset('public/assets/img/service-mobile.m4v')}}" type="video/mp4"/>
  </video>    
</div>
